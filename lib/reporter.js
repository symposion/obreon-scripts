...
const handoutFrame = `
<div style="margin-left:auto; margin-right:auto; width:400px; position:relative">
<div style="padding-bottom:130%">
<div class="scrollyBg" style="position:absolute;!important top:0;!important left:0; right:0; bottom:0;
background: url(http://imgsrv.roll20.net/?src=jesseproductions.com/images/scroll.png) 
...
padding:70px 20px 60px 20px;"> <!--CONTENT-->
</div>
</div>
</div>`;
...
module.exports = class Reporter {
  ...
  frameHandout(entries) {
    return handoutFrame.replace('<!--CONTENT-->', entries.join('<br>'));
  }
};
