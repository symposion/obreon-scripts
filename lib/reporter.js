...
const elementRenderers = {
  h1(content) {
    return `<h6 style="margin:0;font-size:22px;text-transform:none;"><br>${content}</h6>`;
  },
  h2(content) {
    return `<h6 style=margin:0;font-size:20px;text-transform:none;"><br>${content}</h6>`;
  },
  h3(content) {
    return `<h6 style="margin:0;font-size:18px;text-transform:none;"><br>${content}</h6>`;
  },
  h4(content) {
    return `<h6 style="margin:0;font-size:16px;text-transform:none;"><br>${content}</h6>`;
  },
  p(content) {
...
module.exports = class Reporter {
  ...
  lookupCharacterName(characterId) {
    const char = this.roll20.getObj('character', characterId);
    return char ? char.get('name') : char;
  }
  ...
  makeHandoutScrollWriter() {
    return new ScrollHandout(this.logger, this);
  }
...
class ScrollHandout {
  ...
  lookupCharacterName(characterId) {
    return this._reporter.lookupCharacterName(characterId);
  }
...
class ScrollMessage {
  ...
  lookupCharacterName(characterId) {
    return this.reporter.lookupCharacterName(characterId);
  }
