...
background: url(https://s3.amazonaws.com/files.d20.io/images/21093605/ckajybJykpZpyzPK_rcmFw/thumb.png?1468962895) 
    no-repeat 34% 0/cover !important;
line-height:1.2;font-family: fantasy;font-size: 130%;font-weight: bold;font-style: oblique;color: black;
padding:85px 30px 85px 30px;"> <!--CONTENT-->
</div>
</div>
</div>`;
...
const elementRenderers = {
  h1(content) {
    return `<h6 style="margin-bottom:0.3em; font-size:22px;text-transform:none;">${content}</h6>`;
  },
  h2(content) {
    return `<h6 style="margin-bottom:0.3em; font-size:20px;text-transform:none;">${content}</h6>`;
  },
  h3(content) {
    return `<h6 style="margin-bottom:0.3em; font-size:18px;text-transform:none;">${content}</h6>`;
  },
  h4(content) {
    return `<h6 style="margin-bottom:0.3em; font-size:16px;text-transform:none;">${content}</h6>`;
  },
  p(content) {
    return `<nav style="margin: 0; font-size:14px;text-transform:none;">${content}</nav>`;
  },
};
